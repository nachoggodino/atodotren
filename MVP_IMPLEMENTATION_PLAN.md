...
Pilot reporting accepts both compact line inputs such as `C1` and official labels such as `C-1`, preserving the official label in output. Worst-line and worst-station Telegram rankings require respectively 100 and 30 usable observations so tiny samples are reported as insufficient rather than presented as meaningful extremes.
