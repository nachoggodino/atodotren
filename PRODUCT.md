...
Madrid Cercanías commuters checking a line, station, or train; citizens investigating service reliability; and journalists, researchers, and advocates seeking reproducible evidence.

Users may need an immediate live answer during a journey or deeper historical analysis of recurring delay patterns.
...
Incisive, trustworthy, energetic.

The voice is evidence-first and precise, with a deliberate critical bias toward poor service. It avoids anger, sensationalism, and institutional detachment.
...
- A dense analytical terminal where every chart competes for attention
- A playful transit app whose decoration weakens its credibility
- A flashy data story that prioritizes spectacle over comprehension
...
Support keyboard navigation, screen-reader summaries, sufficient contrast, color-blind-safe encodings, reduced motion, and comprehensible alternatives for charts. Color must never be the only carrier of delay, cancellation, confidence, or freshness.
