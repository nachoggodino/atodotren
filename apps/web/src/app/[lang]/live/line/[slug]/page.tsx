  ...
  return (
    <div className="page-shell pb-20 pt-7 sm:pt-9">
      <LiveHeader
        ...
        contextColor={data.context.color}
        subtitle={`${messages.common.line} ${data.context.name[lang]}`}
        title={messages.nav.live}
      />
      <div className="mt-5">
      ...
      <section className="mt-9">
        <LiveLineVisualization
          patterns={data.patterns}
          trains={data.trains}
          matrix={matrix}
          lineColor={data.context.color}
          lang={lang}
          messages={messages}
        />
      </section>
