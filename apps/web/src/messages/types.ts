export interface Messages {
  ...
  live: { title: string; networkTitle: string; comparison: string; comparisonUnavailable: string; comparisonInsufficient: string; trains: string; activeTrains: string; schematic: string; dailyMatrix: string; viewMode: string; towards: string; inferred: string; reported: string; positionUnavailable: string; lastPositionUpdate: string; expectedTime: string; delay: string; nextArrival: string; probableArrival: string; sourceArrival: string; observedPresence: string; autoRefresh: string; refreshing: string; hiddenTabPause: string; overnight: string; todayDistributionTitle: string; todayDistributionBody: string; comparisonDescription: string; stationContext: string; punctualityHelp: string; coverageHelp: string; meanHelp: string; medianHelp: string };
