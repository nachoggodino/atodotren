export interface Messages {
  nav: { home: string; live: string; history: string; methodology: string; menu: string; close: string; language: string; theme: string; refresh: string; paused: string; primary: string; light: string; dark: string };
  landing: { eyebrow: string; title: string; body: string; searchLabel: string; searchPlaceholder: string; liveAction: string; historyAction: string; emptySearch: string; searchError: string; summaryLive: string; summaryHistory: string; liveSummaryDetail: string; historySummaryDetail: string; footerDescription: string; methodology: string };
  common: {
