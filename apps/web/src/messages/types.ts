export interface Messages {
  nav: { home: string; live: string; history: string; methodology: string; menu: string; close: string; language: string; theme: string; refresh: string; primary: string; light: string; dark: string };
