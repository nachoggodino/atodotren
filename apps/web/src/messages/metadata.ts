...
export const metadataCopy: Readonly<Record<Lang, MetadataCopy>> = {
  es: {
    ...
    historyNetworkTitle: "Explorar Cercanías Madrid",
    historyNetworkDescription: "Explora puntualidad, retrasos, cobertura, peores estaciones y horas de Cercanías Madrid.",
    historyLineDescription: "Explora el histórico de puntualidad, retrasos, estaciones, tramos y cobertura de la línea {context} de Cercanías Madrid.",
    historyStationDescription: "Explora el histórico de puntualidad, retrasos, volumen y cobertura en {context}, Cercanías Madrid.",
  ...
  en: {
    ...
    historyNetworkTitle: "Explore Madrid Cercanías",
    historyNetworkDescription: "Explore punctuality, delays, coverage, worst stations and worst hours across Madrid Cercanías.",
    historyLineDescription: "Explore historical punctuality, delays, stations, segments and coverage for Madrid Cercanías line {context}.",
    historyStationDescription: "Explore historical punctuality, delays, volume and coverage at {context}, Madrid Cercanías.",
