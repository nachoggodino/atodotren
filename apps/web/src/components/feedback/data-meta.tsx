...
export function DataMeta({ meta, lang, messages }: { readonly meta: ResponseMeta; readonly lang: Lang; readonly messages: Messages }) {
  ...
  return <div className="flex flex-wrap gap-x-5 gap-y-2 border-y border-border py-3 text-xs text-muted" aria-label={lang === "es" ? "Metadatos de los datos" : "Data metadata"}>
