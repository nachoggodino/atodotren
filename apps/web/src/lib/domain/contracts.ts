...
export interface SummaryStats { readonly scheduled: number; readonly observed: number; readonly punctuality: number | null; readonly meanDelaySeconds: number | null; readonly medianDelaySeconds: number | null; readonly canceled: number | null; readonly missing: number | null; readonly distribution: readonly DelayBucket[] }
