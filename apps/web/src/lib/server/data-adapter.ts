import type { HistoryFilters, HistoryResponse, LiveContextResponse, LiveNetworkResponse, MatrixResponse, SearchResult, TrainDetail } from "@/lib/domain/contracts";
...
export interface PublicDataAdapter {
  ...
  matrix(lineSlug: string, serviceDate: string): Promise<MatrixResponse | null>;
  close?(): Promise<void>;
}
