...
try {
  ...
  assert.equal(migrated.applied.at(-1), "0019_web_history_insights.sql");
  ...
  console.log(JSON.stringify({ postgres_compat_contract: true, migrations_latest: "0019_web_history_insights.sql" }));
} finally {
  try {
